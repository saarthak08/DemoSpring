package com.sg.SpringDemo.AnnotationsWithXMLConfiguration.di;
...
*/
    ...
    @Autowired
    public void setFortuneService(@Qualifier("happyFortuneClass") FortuneService fortuneService){
    ...
    @Autowired
    public void doSomeCrazyStuff(@Qualifier("happyFortuneClass") FortuneService fortuneService){
